...
const Index = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Accueil | UFSBD</title>
        <meta name="description" content="Bienvenue sur le site de l'UFSBD, votre source d'information sur la santé bucco-dentaire en France." />
      </Helmet>
              ...
              <div className="grid gap-8 md:grid-cols-3 mb-8">
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    <a href="https://www.ufsbd.fr" target="_blank" rel="noopener noreferrer">
                      <img src="/ufsbd-logo.png" alt="UFSBD Logo" className="h-20 w-auto hover:scale-105 transition-transform cursor-pointer" />
                    </a>
                  </div>
