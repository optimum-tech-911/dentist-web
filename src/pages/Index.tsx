          ...
          <div className="grid gap-8 md:grid-cols-3 mb-8">
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                <a href="https://www.ufsbd.fr" target="_blank" rel="noopener noreferrer">
                  <img src="/lovable-uploads/ab742599-8097-48dc-a1b3-6d031d2f9718.png" alt="UFSBD Logo" className="h-20 w-auto hover:scale-105 transition-transform cursor-pointer" style={{ opacity: 0.8 }} />
                </a>
              </div>
